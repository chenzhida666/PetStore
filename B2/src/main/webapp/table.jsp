		...
		<div class="row-fluid">
			<div class="span12">
				<h3 class="heading">快来灌水</h3>
					...
					<c:if test="${requestScope.linvalid!=null}">
						<div class="alert alert-error">
							<a class="close" data-dismiss="alert">×</a> <strong>操作信息:${requestScope.linvalid}</strong>
						
						</div>
					</c:if>
				
					
					<c:if test="${sessionScope.lsuccess!=null}">
					
						<div class="alert alert-info">
							<a class="close" data-dismiss="alert">×</a> <strong>操作信息:${requestScope.lok}</strong>

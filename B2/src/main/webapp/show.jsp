...
<body class="sidebar_hidden">
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								data-toggle="dropdown"> 
										...
										<c:if test="${sessionScope.lsuccess!=null}">
											<img src="user?action=head&id=${sessionScope.lsuccess.id}" alt="请登录" class="user_avatar" />
											${sessionScope.lsuccess.username}
	...
	<script type="text/javascript">
		$(function() {
			var username = $.cookie('0722u'); // 获得cookie
			var password = $.cookie('0722p');
